...
class TextDataset(data.Dataset):
    ...
    def load_bbox(self):
        ...
        bbox_path = os.path.join(data_dir, 'bounding_boxes.txt')#'CUB_200_2011/bounding_boxes.txt')
        df_bounding_boxes = pd.read_csv(bbox_path, delim_whitespace=True, header=None).astype(int)
        #
        filepath = os.path.join(data_dir, 'images.txt')# 'CUB_200_2011/images.txt')
...
if __name__ == "__main__":
    ...
    imsize = BASE_SIZE * (2**(BRANCH_NUM - 1))  # 256
